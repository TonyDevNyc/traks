...
public class Menu implements Serializable {
	...
	private static final long serialVersionUID = -6061744653132889102L;
	...
	public String toString() {
		return "Menu [menuId=" + menuId + ", parentMenuId=" + parentMenuId + ", text=" + text + ", displayOrder=" + displayOrder + ", itemId=" + itemId + ", iconCss=" + iconCss + ", privilegeNeeded=" + privilegeNeeded + ", link=" + link + "]";
	}
