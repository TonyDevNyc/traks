...
folder are mapped to the application's root namespace, 'TargetTrak'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TargetTrak"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TargetTrak' in the same way
as `"TargetTrak/sass/src"`.
